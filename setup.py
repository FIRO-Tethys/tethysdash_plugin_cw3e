...
setup(
    ...
    entry_points={
        "intake.drivers": [
            ...
            "cw3e_surface_meterology = cw3e_visualizations.surface_meterology:SurfaceMeterology",
            "cw3e_integrated_microwave_animations = cw3e_visualizations.integrated_microwave_animations:IntegratedMicrowaveAnimations",
        ]
    },
