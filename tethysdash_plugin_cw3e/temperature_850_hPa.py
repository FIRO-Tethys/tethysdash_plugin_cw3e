...
BASE_URL = "https://cw3e.ucsd.edu/images/850hpa_temperature_map/v1"
...
class Temperature850hPA(TethysDashPlugin):
    ...
    description = "850-hPa temperature shaded in °C, heights contoured in geopotential meters and winds from the Global Forecast System (GFS). More information can be found at https://cw3e.ucsd.edu/850Temp_NEPac/"
    args = {
        "date": "date",
        "model": ["GFS", "ECMWF"],
    ...
    group = "CW3E"
    label = "850-hPa Temperature Model Analysis and Forecasts"
    type = "image"
    loading_icon = False
    attribution = "CW3E"
    ...
    def _build_url(self, model, region, date_str, forecast_hour):
        return (
            ...
            f"850hpa_temperature_map__v1__{model}__{region}__{date_str}__1__{forecast_hour}.png"
        )
    ...
    def _resolve_latest_url(self, model, interval, region, forecast_hour):
        ...
        raise VisualizationError(
            f"No 850-hPa temperature image found for {self.model} "
